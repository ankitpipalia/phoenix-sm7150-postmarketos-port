...
- **Patch 0010 keeps SMB input telemetry available while charge behavior is inhibited.** It also corrects SMB5 status/OV/ICL decoding and prescaled voltage handling. Validate the readings against QGauge/TCPM on hardware after every kernel rebase.
